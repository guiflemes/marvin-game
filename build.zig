...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("marvin_game", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "marvin_game" is the name you will use in your source code to
                // import this module (e.g. `@import("marvin_game")`). The name is
